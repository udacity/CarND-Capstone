...
class Controller(object):
    def __init__(self, wheel_base, steer_ratio, min_speed, max_lat_accel, max_steer_angle): # , *args, **kwargs
        ...
        self.velocity_pid = PID(0.6, 0.05, 0.1, 0)
    ...
    def control(self, cte, linear_velocity, angular_velocity, current_velocity, vehicle_cur_ang, time_elapsed):
        ...
        steer = self.steer_control.get_steering(linear_velocity, angular_velocity, current_velocity) + 0.6*(angular_velocity - vehicle_cur_ang)
