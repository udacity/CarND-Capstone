...
class Controller(object):
    def __init__(self, wheel_base, steer_ratio, min_speed, max_lat_accel, max_steer_angle, accel_limit, decel_limit, loop_frequency):
        # TODO: Implement
        ...
        self.throttle_controller = PID(0.15, 0.0, 0.0, mn=decel_limit, mx=accel_limit)
    ...
    def control(self, target_angular_velocity, target_linear_velocity, current_angular_velocity, current_linear_velocity, dbw_enabled):
        ...
        if last_timestamp != None:
            ...
            dt =  (current_timestamp - last_timestamp).secs
