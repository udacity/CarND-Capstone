...
class TLClassifierCV(object):
    ...
    def train(self,img):
        ...
        #normalize hist
        img_norm = self.local_normalize_histogram(img);
...
if __name__ == "__main__":
    # Red
    img = load_img('train/1.jpg')
    # Yellow
    #img = load_img('train/113.jpg')
    # Green
    #img = load_img('train/106.jpg')
    # None
    #img = load_img('train/174.jpg')


    classifier = TLClassifierCV()
    #for img in glob.glob("train/*.jpg"):
    #    n= cv2.imread(img)

    classifier.train(img)
