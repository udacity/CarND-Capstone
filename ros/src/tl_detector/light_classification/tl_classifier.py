...
class TLClassifier(object):
    def __init__(self, simulator):
        ...
        self.graph_classification = self.load_graph('models/model_classification.pb', config)

        if simulator:
            graph_detection = self.load_graph('models/model_detection_simulator.pb', config)
        else:
            graph_detection = self.load_graph('models/model_detection_site.pb', config)
