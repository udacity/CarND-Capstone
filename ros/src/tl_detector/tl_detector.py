...
class TLDetector(object):
    def __init__(self):
        ...
        sub1 = rospy.Subscriber('/current_pose', PoseStamped, self.pose_cb, queue_size=5)
        sub2 = rospy.Subscriber('/base_waypoints', Lane, self.waypoints_cb, queue_size=5)
    ...
    def process_traffic_lights(self):
        ...
        return light_wp, TrafficLight.UNKNOWN #light.state
