...
import cv2
import os
os.chdir(r'C:\Users\priya\Documents\carnd\Term3\CarND-Capstone\TL_model\sim_traffic_images')
os.listdir()
loc = 'training_folder/train/green/left0003.jpg'
img = cv2.imread(loc)
...
top_model_weights_path = 'bottleneck_sim_model.h5'
train_data_dir = 'training_folder/train'
validation_data_dir = 'training_folder/validation'
...
# 464/464 [==============================] - 0s - loss: 0.0262 - acc: 0.9892 - val_loss: 0.0019 - val_acc: 1.0000
