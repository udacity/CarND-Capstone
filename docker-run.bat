...
rem ===========
docker run -d --rm -it -p 4567:4567 -p 22:22 -v "%CurPath%":/capstone -v "%CurPath%/.ros":/root/.ros/ -v "%CurPath%/.ros/log":/root/.ros/log/ %DockerUserName%/%DockerImageName%:%DockerImageTag%
