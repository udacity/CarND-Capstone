...
current_angular_velocity, dbw_time, throttle, brake, steering, target_linear_velocity, target_angular_velocity,current_linear_velocity, dbw_status = np.loadtxt('/home/student/.ros/log/latest/dbw_node-4-stdout.log', unpack = True) 
wu_time, x, y, wp, cx, cy = np.loadtxt('/home/student/.ros/log/latest/waypoint_updater-7-stdout.log', unpack = True)
